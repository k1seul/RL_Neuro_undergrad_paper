...
def curiosity_based_train_explore_control(rand_seed = 0, maxent=False, simulation_num = 3, simulation_max_episode = 20, explore_prob=0.1):
    ...
    game_name = "Curiosity_counter_model_explore_control" if not(maxent) else "Curiosity_maxent_model_explore_control"
